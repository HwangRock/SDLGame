...
public:
	...
	virtual void SetVar()
	{
		...
		FadeFloor* fadefloor1 = new FadeFloor({ 115,650,100,50 }); //215,90
		FadeFloor* fadefloor2 = new FadeFloor({ 30,580,100,50 });
		FadeFloor* fadefloor3 = new FadeFloor({ 311,93,100,50 });
		FadeFloor* fadefloor4 = new FadeFloor({ 501,93,100,50 });
		FadeFloor* fadefloor5 = new FadeFloor({ 691,93,100,50 });
		FadeFloor* fadefloor6 = new FadeFloor({ 881,93,100,50 });

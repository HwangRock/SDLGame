...
const int PHASE_STAGE7 = 7;
const int PHASE_STAGE8 = 8;
const int PHASE_ENDING = 9;
const int PHASE_OVER = 10;
const int PHASE_CLEAR = 11;
const int PHASE_ESC = 12;
const int PHASE_MANUAL = 13;
const int PHASE_FINISH = 14;
